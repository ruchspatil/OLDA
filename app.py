...
st.markdown("<h1 style='text-align: center; color: red;'>OLDA (Olympics Analysis)</h1>", unsafe_allow_html=True)
...
if user_menu == 'MEDAL TALLY':
    ...
    my_expander = st.expander("SELECT YEAR & COUNTRY", expanded=False)
    with my_expander:
